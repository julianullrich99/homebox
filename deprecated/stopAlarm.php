...
//exec("python client.py " . $r . " " . $g . " " . $b, $arr);
//print_r($arr);

CommunicateWithRobot('{"type":"schedule","action":"stopTimer","data":{"hostname":"robot","port":1234,"payload":"{\"type\":\"audio\",\"action\":\"mute\"}" }}');
...
function CommunicateWithRobot($Commands) {
        ...
        // }
        // $Telemetry = socket_read($socket,1000);
        // socket_close($socket);
        // return $Telemetry;
